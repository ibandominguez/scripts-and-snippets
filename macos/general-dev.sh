...
brewPackages=(php56 mcrypt php56-mcrypt mysql redis imagemagick graphicsmagick postgresql mongodb git brew-cask homebrew/php/composer nginx homebrew/apache/httpd24 tree curl android-sdk python install sdl2 sdl2_image sdl2_ttf sdl2_mixer gstreamer watchman)
casksPackages=(google-chrome node firefox virtualbox vagrant vagrant-manager filezilla atom skype sequel-pro arduino opera qlcolorcode qlstephen qlmarkdown quicklook-json qlprettypatch quicklook-csv betterzipql qlimagesize webpquicklook suspicious-package)
