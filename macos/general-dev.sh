...
npmPackages="grunt-cli gulp bower yo webpack generator-karma generator-angular firebase-tools nodemon sails protractor phantomjs forever nightwatch phonegap cordova jade express ionic react-native-cli ios-sim ios-deploy jasmine-node"
