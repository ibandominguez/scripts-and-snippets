...
casksPackages=(google-chrome firefox mysqlworkbench virtualbox vagrant vagrant-manager filezilla atom skype java sequel-pro arduino opera qlmarkdown quicklook-json qlprettypatch betterzipql qlimagesize webpquicklook android-studio Caskroom/cask/gimp)
