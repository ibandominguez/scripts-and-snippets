...
npmPackages="grunt-cli gulp bower yo generator-karma generator-angular nodemon sails protractor phantomjs forever phonegap cordova jade express ionic react-native-cli ios-sim ios-deploy"
